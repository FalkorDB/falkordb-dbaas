    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen py-2">
            <main className="flex flex-col items-center justify-center flex-1 px-20 text-center space-y-10">
                <h1 className="text-6xl">Create a new Database</h1>
                <form className="flex flex-col space-y-5" onSubmit={createDatabase}>
                    <div className="flex flex-row space-x-4 items-center">
                        <Label className="text-2xl p-2" htmlFor="databaseName">Database Name:</Label>
                        <input className="text-2xl border-4" ref={databaseName} id="databaseName" type="text" required />
                    </div>
                    <div className="flex flex-row space-x-4 items-center">
                        <Label className="text-2xl min-w-fit p-2 text-left" htmlFor="machineType">Machine Type:</Label>
                    ...
                    <Button className="p-8 text-2xl">Create</Button>
                </form>
            </main>
        </div>
    )
