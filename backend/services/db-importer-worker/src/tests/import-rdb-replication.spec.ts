...
const task = {
  ...
  payload: {
    ...
    region: 'us-central1',
    instanceId: 'instance-51rz1et0r',
    podIds: ['node-mz-0', 'node-mz-1'],
    hasTLS: true,
    bucketName: 'falkordb-dev-rdb-exports-f7a2434f',
    fileName: `imports/instance-51rz1et0r/dump.rdb`,
    rdbSizeFileName: `imports/instance-51rz1et0r/rdb-size.txt`,
    rdbKeyNumberFileName: `imports/instance-51rz1et0r/key-count.txt`,
