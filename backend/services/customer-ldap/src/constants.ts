...
export const ALLOWED_SENTINEL_ACL = "+INFO +PING +AUTH +ROLE +CLIENT +SENTINEL|GET-MASTER-ADDR-BY-NAME +SENTINEL|MASTERS +SENTINEL|MASTER +SENTINEL|REPLICAS +SENTINEL|SENTINELS +SENTINEL|FAILOVER +SENTINEL|FLUSHCONFIG"